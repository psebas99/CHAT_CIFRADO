...
while True:
    ...
    while tx:
        if cifrado == 1:
            mensaje = input("TÚ: ")
            if mensaje == "0":
                enviar(hamming(cesar_code("vamosacambiardecifrado")))
                choose_cifrado = True
                leer_cesar = leer_hill = leer_vigenere = False
                break
            ...
            mensaje = input("TÚ: ")
            if mensaje == "0":
                enviar(hamming(hill_code("vamosacambiardecifrado")))
                choose_cifrado = True
                leer_cesar = leer_hill = leer_vigenere = False
                break
            ...
            mensaje = input("TÚ: ")
            if mensaje == "0":
                enviar(hamming(vig_code("vamosacambiardecifrado")))
                choose_cifrado = True
                leer_cesar = leer_hill = leer_vigenere = False
                break
    ...
    while rx:
        ...
        if leer_cesar:
            decodificado = deco_hamming(mensaje)
            decodificado_cesar = cesar_decode(decodificado)
            if decodificado_cesar == "vamosacambiardecifrado":
                choose_decodificado = True
                break
            ...
            decodificado = deco_hamming(mensaje)
            decodificado_hill = hill_decode(decodificado)
            if decodificado_hill == "vamosacambiardecifrado  ":
                choose_decodificado = True
                break
            ...
            decodificado = deco_hamming(mensaje)
            decodificado_vigenere = vigenere_decode(decodificado)
            if decodificado_vigenere == "vamosacambiardecifrado":
                choose_decodificado = True
                break
